...
from maelstrom.cassandra.tests.test import CassandraTestCase
...
class SearchUnitTests(CassandraTestCase):
    ...
    def test_search_refined(self):
        ...
        username_is_subset = search_username.model_ids.issubset(search_general.model_ids)
        email_is_subset = search_email.model_ids.issubset(search_general.model_ids)
